            ...
            <aside class="menu">
                <div id="side-header" class="side-header">
                    <div class="menu-label imgLabel">
                       <router-link :to="{name: 'Landing'}" style="color: white">
                        ...
                        <p class="amihealthy">AMIHEALTHY</p>
                        </router-link>
                    </div>
                </div>
                ...
                <div class="side-body">
                    ...
                    <ul class="menu-list">
                        ...
                        <li><router-link v-bind:to="{ name: 'PostBarang'}"  ><i class="fa fa-file m-r-10" aria-hidden="true"></i>  <span>Barang</span> </router-link></li>
                        <li><router-link v-bind:to="{ name: 'PostComponent', params: { kategori: 'PPDB' }}"  ><i class="fa fa-file m-r-10" aria-hidden="true"></i>  <span>Transaksi</span> </router-link></li>
                    </ul>
                </div>
            </aside>
        </div>
